...
export class CatalogueFormComponent implements OnInit {
  ...
  readonly providerAbbreviationDesc: sd.Description = sd.catalogueDescMap.get('providerAbbreviationDesc');
  readonly websiteDesc: sd.Description = sd.catalogueDescMap.get('websiteDesc');
  readonly providerDescriptionDesc: sd.Description = sd.catalogueDescMap.get('providerDescriptionDesc');
  readonly providerLogoDesc: sd.Description = sd.catalogueDescMap.get('providerLogoDesc');
  readonly providerMultimediaURLDesc: sd.Description = sd.catalogueDescMap.get('providerMultimediaURLDesc');
  readonly providerMultimediaNameDesc: sd.Description = sd.catalogueDescMap.get('providerMultimediaNameDesc');
  readonly providerScientificDomainDesc: sd.Description = sd.catalogueDescMap.get('providerScientificDomainDesc');
  readonly providerScientificSubdomainsDesc: sd.Description = sd.catalogueDescMap.get('providerScientificSubdomainsDesc');
  ...
  readonly providerTagsDesc: sd.Description = sd.catalogueDescMap.get('providerTagsDesc');
  ...
  readonly providerMainContactFirstNameDesc: sd.Description = sd.catalogueDescMap.get('providerMainContactFirstNameDesc');
  readonly providerMainContactLastNameDesc: sd.Description = sd.catalogueDescMap.get('providerMainContactLastNameDesc');
  readonly providerMainContactEmailDesc: sd.Description = sd.catalogueDescMap.get('providerMainContactEmailDesc');
  readonly providerMainContactPhoneDesc: sd.Description = sd.catalogueDescMap.get('providerMainContactPhoneDesc');
  readonly providerMainContactPositionDesc: sd.Description = sd.catalogueDescMap.get('providerMainContactPositionDesc');
  readonly providerPublicContactFirstNameDesc: sd.Description = sd.catalogueDescMap.get('providerPublicContactFirstNameDesc');
  readonly providerPublicContactLastNameDesc: sd.Description = sd.catalogueDescMap.get('providerPublicContactLastNameDesc');
  readonly providerPublicContactEmailDesc: sd.Description = sd.catalogueDescMap.get('providerPublicContactEmailDesc');
  readonly providerPublicContactPhoneDesc: sd.Description = sd.catalogueDescMap.get('providerPublicContactPhoneDesc');
  readonly providerPublicContactPositionDesc: sd.Description = sd.catalogueDescMap.get('providerPublicContactPositionDesc');
