...
export class ResourceFormToPdfComponent implements OnInit {
  ...
  readonly multimediaDesc: dm.Description = dm.serviceDescMap.get('multimediaDesc');
  ...
  readonly useCasesDesc: dm.Description = dm.serviceDescMap.get('useCasesDesc');
  ...
  ngOnInit() {
    zip(
      ...
      this.resourceService.getResourcesAsVocs(environment.CATALOGUE)
    ).subscribe(suc => {
