...
export const taglineDesc = {label: 'Tagline', mandatory: true, desc: 'Short catch-phrase for marketing and advertising purposes. It will be usually displayed close the service name and should refer to the main value or purpose of the service.'};
...
export const resourceProvidersDesc = {label: 'Resource Providers', mandatory: false, desc: 'The organisation that manages and delivers the service/resource.'};
...
export const languageAvailabilitiesDesc = {label: 'Language Availability', mandatory: true, desc: 'Languages of the user interface of the service or the resource.'};
// Contact Information
...
// Other Contacts
export const helpdeskEmailDesc = {label: 'Helpdesk Email', mandatory: true, desc: 'Email of the heldesk department.'};
export const securityContactEmailDesc = {label: 'Security Contact Email', mandatory: true, desc: 'The email to contact the Provider for critical security issues about this Resource.'};
export const quotationEmailDesc = {label: 'Quotation Email', mandatory: false, desc: 'Email of the quotations department.'};
// Maturity Information
export const phaseDesc = {label: 'Life Cycle Status', mandatory: false, desc: 'Phase of the service/resource lifecycle.'};
export const technologyReadinessLevelDesc = {label: 'Technology Readiness Level', mandatory: true, desc: 'The Technology Readiness Level of the Tag of the service/resource.'};
...
export const requiredServicesDesc = {label: 'Required Resources', mandatory: false, desc: 'List of other services/resources required with this service/resource.'};
export const relatedServicesDesc = {label: 'Related Resources', mandatory: false, desc: 'List of other services/resources that are commonly used with this service/resource.'};
...
export const helpdeskPageDesc = {label: 'Helpdesk Page', mandatory: false, desc: 'The URL to a webpage with the contact person or helpdesk to ask more information from the service/resource provider about this service.'};
...
export const serviceLevelDesc = {label: 'Service Level', mandatory: false, desc: 'Webpage with the information about the levels of performance that a service/resource provider is expected to deliver.'};
...
export const resourceOrganisationDesc = {label: 'Resource Organisation', mandatory: true, desc: 'The name (or abbreviation) of the organisation that manages or delivers the resource, or that coordinates resource delivery in a federated scenario.'};
export const resourceGeographicLocationsDesc = {label: 'Geographic Locations', mandatory: false, desc: 'List of geographic locations where data is stored and processed.'};
...
// Basic Information
export const fullNameDesc = {label: 'Name', mandatory: true, desc: 'Full Name of the organisation providing/offering the service/resource.'};
export const abbreviationDesc = {label: 'Abbreviation', mandatory: true, desc: 'Acronym or abbreviation of the provider.'};
...
export const legalEntityDesc = {label: 'Legal Entity', mandatory: true, desc: 'A Y/N question to define whether the Provider is a Legal Entity or not.'};
...
export const streetNameAndNumberDesc = {label: 'Street Name and Number', mandatory: true, desc: 'Street and Number of incorporation or Physical location of the Provider or its coordinating centre in the case of distributed, virtual, and mobile providers.'};
...
export const affiliationDesc = {label: 'Affiliations', mandatory: false, desc: 'Select the affiliations, networks of the provider. '};
export const networksDesc = {label: 'Networks', mandatory: false, desc: 'Select the networks the RIs is part of.'};
export const structureTypesDesc = {label: 'Structure Type', mandatory: false, desc: 'Defines if the Provider is single-sited, distributed, mobile, virtual, etc.'};
export const ESFRIDomainDesc = {label: 'ESFRI Domain', mandatory: false, desc: 'ESFRI domain classification. '};
export const ESFRITypeDesc = {label: 'ESFRI Type', mandatory: false, desc: 'If the RI is (part of) an ESFRI project indicate how the RI participates: a) RI is node of an ESFRI project, b) RI is an ESFRI project, c) RI is an ESFRI landmark.'};
export const merilScientificDomainsDesc = {label: 'MERIL Scientific Domain', mandatory: false, desc: 'MERIL scientific domain classification'};
export const merilScientificSubdomainsDesc = {label: 'MERIL Scientific Subdomain', mandatory: false, desc: 'MERIL scientific subdomain classification'};
