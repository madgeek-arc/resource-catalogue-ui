...
export const providerDescMap = new Map()
  ...
  .set('providerMultimediaURLDesc', {mandatory: false, label: 'Multimedia URL', addTitle: 'Multimedia URL', placeholder: 'Write link to multimedia...', desc: 'Links to video, slideshow, photos, screenshots with details of the Provider.'})
  ...
  .set('providerCatalogueIdDesc', {mandatory: false, label: 'Catalogue', addTitle: 'Catalogue', placeholder: 'Select catalogue...', desc: 'The Catalogue this Provider is originally registered at.'})
