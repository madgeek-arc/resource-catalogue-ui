...
export const guidelinesDescMap = new Map()
  ...
  .set('relatedStandardURLDesc', {mandatory: false, label: 'Related Standard URI', placeholder: '', desc: 'Standards related to the guideline. This should point out to related standards only when it is a prerequisitite/depenendency, and likely to influence a Provider\'s design towards interoperability based on the guideline.'})
