...
export class ProviderFormToPdfComponent implements OnInit {
  ...
  readonly providerDescriptionDesc: dm.Description = dm.providerDescMap.get('providerDescriptionDesc');
  readonly providerLogoDesc: dm.Description = dm.providerDescMap.get('providerLogoDesc');
  readonly providerMultimediaDesc: dm.Description = dm.providerDescMap.get('providerMultimediaDesc');
  readonly providerScientificDomainDesc: dm.Description = dm.providerDescMap.get('providerScientificDomainDesc');
  readonly providerScientificSubdomainsDesc: dm.Description = dm.providerDescMap.get('providerScientificSubdomainsDesc');
  ...
  readonly providerTagsDesc: dm.Description = dm.providerDescMap.get('providerTagsDesc');
  ...
  readonly providerMainContactFirstNameDesc: dm.Description = dm.providerDescMap.get('providerMainContactFirstNameDesc');
  readonly providerMainContactLastNameDesc: dm.Description = dm.providerDescMap.get('providerMainContactLastNameDesc');
  readonly providerMainContactEmailDesc: dm.Description = dm.providerDescMap.get('providerMainContactEmailDesc');
  readonly providerMainContactPhoneDesc: dm.Description = dm.providerDescMap.get('providerMainContactPhoneDesc');
  readonly providerMainContactPositionDesc: dm.Description = dm.providerDescMap.get('providerMainContactPositionDesc');
  readonly providerPublicContactFirstNameDesc: dm.Description = dm.providerDescMap.get('providerPublicContactFirstNameDesc');
  readonly providerPublicContactLastNameDesc: dm.Description = dm.providerDescMap.get('providerPublicContactLastNameDesc');
  readonly providerPublicContactEmailDesc: dm.Description = dm.providerDescMap.get('providerPublicContactEmailDesc');
  readonly providerPublicContactPhoneDesc: dm.Description = dm.providerDescMap.get('providerPublicContactPhoneDesc');
  readonly providerPublicContactPositionDesc: dm.Description = dm.providerDescMap.get('providerPublicContactPositionDesc');
  readonly providerCertificationsDesc: dm.Description = dm.providerDescMap.get('providerCertificationsDesc');
  ...
  checkFormValidity(name: string): boolean {
    return (this.providerForm.get(name).invalid && this.providerForm.get(name).dirty);
  }

  checkFormArrayValidity(name: string, position: number, groupName?: string): boolean {
    if (groupName) {
      return this.getFieldAsFormArray(name).get([position]).get(groupName).invalid && this.getFieldAsFormArray(name).get([position]).get(groupName).dirty;
    }
