...
export class ServiceEditComponent extends ServiceFormComponent implements OnInit {
  ...
  onSubmitTemplate(service: Service, tempSave: boolean) {
    ...
    this.resourceService[tempSave ? 'uploadTempPendingService' : 'uploadServiceWithMeasurements'](this.serviceForm.value, this.measurements.value).subscribe(
      _service => {
