...
export const           resourceProvidersDesc = {mandatory: false, label: 'Resource Providers', desc: 'The name(s) (or abbreviation(s)) of Provider(s) that manage or deliver the Resource in federated scenarios.'};
export const                     webpageDesc = {mandatory: true,  label: 'Webpage', desc: 'Webpage with information about the service/resource usually hosted and maintained by the Provider.'};
...
export const                  accessModeDesc = {mandatory: false, label: 'Access Mode', desc: 'Eligibility/criteria for granting access to users (excellence-based, free-conditionally, free etc.)'};
...
export const    geographicalAvailabilityDesc = {mandatory: true, label: 'Geographical Availability', desc: 'Locations where the service/resource is offered.'};
export const      languageAvailabilitiesDesc = {mandatory: true, label: 'Language Availability', desc: 'Languages of the user interface of the service/resource.'};
...
// Other
export const               helpdeskEmailDesc = {mandatory: true,  label: 'Helpdesk Email', desc: 'The email to ask more information from the Provider about this Resource.'};
...
export const    technologyReadinessLevelDesc = {mandatory: true,  label: 'Technology Readiness Level', desc: 'The Technology Readiness Level of the service/resource.'};
...
export const            relatedPlatformsDesc = {mandatory: false, label: 'Related Platform', desc: 'List of suites or thematic platforms in which the Resource is engaged or Providers (Provider groups) contributing to this Resource.'};
...
export const                       orderDesc = {mandatory: false, label: 'Order', desc: 'Webpage through which an order for the service/resource can be placed.'};

// Financial Information //
export const                paymentModelDesc = {mandatory: false, label: 'Payment Model', desc: 'Webpage with the supported payment models and restrictions that apply to each of them.'};
export const                     pricingDesc = {mandatory: false, label: 'Pricing', desc: 'Webpage with the information on the price scheme for this Resource in case the customer is charged for.'};
...
export const                   abbreviationDesc = {mandatory: true, label: 'Abbreviation', desc: 'Abbreviation or short name of the Provider.'};
...
export const   providerScientificSubdomainsDesc = {mandatory: false, label: 'Scientific Subdomain', desc: 'A named group of Providers that offer access to the same type of resource or capabilities, within the defined domain.'};
...
export const                     postalCodeDesc = {mandatory: true, label: 'Postal Code', desc: 'Postal code of incorporation or Physical location of the Provider or its coordinating centre in the case of distributed, virtual, and mobile providers.'};
export const                           cityDesc = {mandatory: true, label: 'City', desc: 'City of incorporation or Physical location of the Provider or its coordinating centre in the case of distributed, virtual, and mobile providers.'};
export const                         regionDesc = {mandatory: false, label: 'Region', desc: 'Region of incorporation or Physical location of the Provider or its coordinating centre in the case of distributed, virtual, and mobile providers.'};
...
export const                    affiliationDesc = {mandatory: false, label: 'Affiliations', desc: 'Providers that are members or affiliated or associated with other organisations should list those organisations here.'};
export const                       networksDesc = {mandatory: false, label: 'Networks', desc: 'Select the networks the Provider is participating in.'};
export const                 structureTypesDesc = {mandatory: false, label: 'Structure Type', desc: 'Defines the Provider structure type (single-sited, distributed, mobile, virtual, etc.)'};
