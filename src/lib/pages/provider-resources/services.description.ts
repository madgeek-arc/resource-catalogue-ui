...
export const                        logoDesc = {mandatory: true,  label: 'Logo', placeholder: 'Link to the logo', desc: 'Link to the logo/visual identity of the Resource. The logo will be visible at the Portal. If there is no specific logo for the Resource the logo of the Provider may be used. To obtain the link:  Go to the Resource\'s website --> Right Click on the Resource\'s logo on the website --> Select "Copy Image Link" --> Paste it in the above field.'};
...
export const                   providerLogoDesc = {mandatory: true, label: 'Logo', placeholder: 'logo URL', desc: 'Link to the logo/visual identity of the Provider. The logo will be visible at the Portal. To obtain the link:  Go to the Resource Provider\'s website --> Right Click on the Resource Provider\'s logo on the website --> Select "Copy Image Link" --> Paste it in the above field.'};
