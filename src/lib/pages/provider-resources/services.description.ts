...
// Data Source Policies //
  .set('submissionPolicyURL', {mandatory: false, label: 'Submission Policy URL', placeholder: '', desc: 'This policy provides a comprehensive framework for the contribution of research products. Criteria for submitting content to the repository as well as product preparation guidelines can be stated. Concepts for quality assurance may be provided.'})
  .set('preservationPolicyURL', {mandatory: false, label: 'Preservation Policy URL', placeholder: '', desc: 'This policy provides a comprehensive framework for the long-term preservation of the research products. Principles aims and responsibilities must be clarified. An important aspect is the description of preservation concepts to ensure the technical and conceptual utility of the content.'})
  .set('versionControl', {mandatory: false, label: 'Version Control', placeholder: '', desc: 'If data versioning is supported: the data source explicitly allows the deposition of different versions of the same object.'})
  .set('persistentIdentitySystems', {mandatory: false, label: 'Persistent Identity Systems', placeholder: '', desc: 'The persistent identifier systems that are used by the Data Source to identify the EntityType it supports.'})
  .set('persistentIdentityEntityType', {mandatory: false, label: 'Persistent Identity EntityType', placeholder: '', desc: 'Specify the EntityType to which the persistent identifier is referring to.'})
  .set('persistentIdentityEntityTypeScheme', {mandatory: false, label: 'Persistent Identity EntityType Scheme', placeholder: '', desc: 'Specify the list of persistent identifier schemes used to refer to EntityTypes.'})
// Data Source content //
  .set('jurisdiction', {mandatory: false, label: 'Jurisdiction', placeholder: '', desc: 'The property defines the jurisdiction of the users of the data source, based on the vocabulary for this property.'})
  .set('dataSourceClassification', {mandatory: false, label: 'Data Source Classification', placeholder: '', desc: 'The specific type of the data source based on the vocabulary defined for this property.'})
  .set('researchEntityTypes', {mandatory: false, label: 'Research Entity Types', placeholder: '', desc: 'The types of OpenAIRE entities managed by the data source, based on the vocabulary for this property.'})
  .set('thematic', {mandatory: false, label: 'thematic', placeholder: '', desc: 'Boolean value specifying if the data source is dedicated to a given discipline or is instead discipline agnostic.'})
// Research Product policies //
  .set('researchProductLicensing', {mandatory: false, label: 'Research Product Licensing', placeholder: '', desc: 'Licenses under which the research products contained within the data sources can be made available. Repositories can allow a license to be defined for each research product, while for scientific databases the database is typically provided under a single license.'})
  .set('researchProductLicenseName', {mandatory: false, label: 'Research Product License Name', placeholder: '', desc: ''})
  .set('researchProductLicenseURL', {mandatory: false, label: 'Research Product License URL', placeholder: '', desc: ''})
  .set('researchProductAccessPolicy', {mandatory: false, label: 'Research Product Access Policy', placeholder: '', desc: ''})
// Research Product Metadata //
  .set('researchProductMetadataLicensing', {mandatory: false, label: 'Research Product Metadata Licensing', placeholder: '', desc: 'Metadata Policy for information describing items in the repository: Access and re-use of metadata'})
  .set('researchProductMetadataLicenseName', {mandatory: false, label: 'Research Product Metadata License Name', placeholder: '', desc: ''})
  .set('researchProductMetadataLicenseURL', {mandatory: false, label: 'Research Product Metadata License URL', placeholder: '', desc: ''})
  .set('researchProductMetadataAccessPolicy', {mandatory: false, label: 'Research Product Metadata Access Policy', placeholder: '', desc: ''})
;
