...
export const lifeCycleStatusDesc = {label: 'Life Cycle Status', mandatory: true, desc: 'Select the current status of the provider life-cycle from the following options: Under Construction, Operational, Being Upgraded, Other'};
