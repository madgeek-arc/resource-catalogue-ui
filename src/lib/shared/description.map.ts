...
export const providerDescMap = new Map()
  ...
  .set('nodeDesc', {mandatory: false, label: 'Node', placeholder: 'Select node...', desc: 'The node in which the Provider belongs to.'})
...
// Basic Information //
  ...
  .set('nodeDesc', {mandatory: false, label: 'Node', placeholder: 'Select node...', desc: 'The node in which the Service belongs to.'})
...
export const catalogueDescMap = new Map()
  ...
  .set('nodeDesc', {mandatory: false, label: 'Node', placeholder: 'Select node...', desc: 'The node in which the Catalogue belongs to.'})
...
export const datasourceDescMap = new Map()
  .set('nodeDesc', {mandatory: false, label: 'Node', placeholder: 'Select node...', desc: 'The node in which the Datasource belongs to.'})
