...
export const providerDescMap = new Map()
  ...
  .set('multimediaURLDesc', {mandatory: false, label: 'Multimedia URL', addTitle: 'Multimedia URL', placeholder: 'Write link to multimedia...', desc: 'Links to video, slideshow, photos, screenshots with details of the Provider.'})
  .set('multimediaNameDesc', {mandatory: false, label: 'Multimedia Name', addTitle: 'Multimedia Name', placeholder: 'Write multimedia name...', desc: 'Short description of the Multimedia content.'})
  ...
  .set('tagsDesc', {mandatory: false, label: 'Tags', addTitle: 'Tag', placeholder: 'Write tag...', desc: 'Keywords associated to the Provider to simplify search by relevant keywords.'})
  ...
  .set('certificationsDesc', {mandatory: false, label: 'Certifications', addTitle: 'Certification', placeholder: 'Write certifications...', desc: 'List of certifications obtained for the Provider (including the certification body, the certificate number or URL if available).'})
  // Other //
  ...
  .set('catalogueIdDesc', {mandatory: false, label: 'Catalogue', addTitle: 'Catalogue', placeholder: 'Select catalogue...', desc: 'The Catalogue this Provider is originally registered at.'})
...
// Marketing Information //
  ...
  .set('multimediaURLDesc', {mandatory: false, label: 'Multimedia URL', addTitle: 'Multimedia URL', placeholder: 'Write link to multimedia...', desc: 'Link to video, screenshots or slides showing details of the Resource.'})
  .set('multimediaNameDesc', {mandatory: false, label: 'Multimedia Name', addTitle: 'Multimedia Name', placeholder: 'Write multimedia name...', desc: 'Short description of the Multimedia content.'})
  .set('useCaseURLDesc', {mandatory: false, label: 'Use Cases URL', addTitle: 'Use Case URL', placeholder: 'Write use case URL...', desc: 'Link to use cases supported by this Resource.'})
  .set('useCaseNameDesc', {mandatory: false, label: 'Use Cases Name', addTitle: 'Use Case Name', placeholder: 'Write use case name...', desc: 'Short description of the Use Case content.'})
// Classification Information //
...
// Dependencies Information //
  ...
  .set('resourceCatalogueIdDesc', {mandatory: false, label: 'Catalogue', addTitle: 'Catalogue', placeholder: 'Select catalogue...', desc: 'The Catalogue this Resource is originally registered at.'})
...
export const catalogueDescMap = new Map()
  ...
  .set('multimediaURLDesc', {mandatory: false, label: 'Multimedia URL', addTitle: 'Multimedia URL', placeholder: 'Write link to multimedia...', desc: 'Links to video, slideshow, photos, screenshots with details of the Catalogue.'})
  .set('multimediaNameDesc', {mandatory: false, label: 'Multimedia Name', addTitle: 'Multimedia Name', placeholder: 'Write multimedia name...', desc: 'Short description of the Multimedia content.'})
  // Classification Information //
  ...
  .set('tagsDesc', {mandatory: false, label: 'Tags', addTitle: 'Tag', placeholder: 'Write tag...', desc: 'Keywords associated to the Catalogue to simplify search by relevant keywords.'})
  // Location Information //
