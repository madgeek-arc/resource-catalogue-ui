...
export const                        logoDesc = {mandatory: true,  label: 'Logo', placeholder: 'Link to the logo', desc: 'Link to the logo/visual identity of the Resource. The logo will be visible at the Portal. If there is no specific logo for the Resource the logo of the Provider may be used. To obtain the link:  Go to the Service\'s website --> Right Click on the Service\'s logo on the website --> Select "Copy Image Link" --> Paste it in the above field.'};
...
export const                serviceLevelDesc = {mandatory: false, label: 'Service Level', placeholder: 'service level URL', desc: 'Webpage with the information about the levels of performance of the Resource that a Provider is expected to deliver.'};
